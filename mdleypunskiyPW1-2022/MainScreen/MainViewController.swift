...
final class MainViewController: UIViewController {
    ...
    private func setupViews() {
        ...
        NSLayoutConstraint.activate([
            ...
            viewsList[0].heightAnchor.constraint(equalToConstant: (UIScreen.main.bounds.height / 6) - CGFloat((viewsList.count / 2 + 1)) * HEIGHT_INDENT),
            ...
            viewsList[1].heightAnchor.constraint(equalToConstant: (UIScreen.main.bounds.height / 3) - CGFloat((viewsList.count / 2 + 1)) * HEIGHT_INDENT),
            ...
            viewsList[2].heightAnchor.constraint(equalToConstant: (UIScreen.main.bounds.height / 2) - CGFloat((viewsList.count / 2 + 1)) * HEIGHT_INDENT),
        ...
        NSLayoutConstraint.activate([
            ...
            viewsList[3].heightAnchor.constraint(equalToConstant: (UIScreen.main.bounds.height / 6) - CGFloat((viewsList.count / 2 + 1)) * HEIGHT_INDENT),
            ...
            viewsList[4].heightAnchor.constraint(equalToConstant: (UIScreen.main.bounds.height / 3) - CGFloat((viewsList.count / 2 + 1)) * HEIGHT_INDENT),
            ...
            viewsList[5].heightAnchor.constraint(equalToConstant: (UIScreen.main.bounds.height / 2) - CGFloat((viewsList.count / 2 + 1)) * HEIGHT_INDENT),
